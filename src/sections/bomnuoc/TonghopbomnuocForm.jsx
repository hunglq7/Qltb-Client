...
const TonghopbomnuocForm = ({ handleSubmit, form, bomNuocList = [], donViList = [], onCancel }) => {
  ...
  return (
    <Form form={form} onFinish={handleSubmit} {...formItemLayout} initialValues={{ remember: true }}>
      ...
      <Form.Item name="bomNuocId" label="Thiết bị" rules={[{ required: true, message: 'Vui lòng chọn thiết bị' }]}>
        <Select placeholder="Chọn tời điện">
          {bomNuocList.map((item) => (
