...
const QuatgioChart = () => {
  const { loading, dataTonghopquatgio, fetchTonghopquatgio } = useTonghopquatgioStore();
  useEffect(() => {
    fetchTonghopquatgio();
  }, []);
  // ✅ LUÔN ÉP DATA VỀ ARRAY
  const listData = useMemo(
    () => (Array.isArray(dataTonghopquatgio) ? dataTonghopquatgio : dataTonghopquatgio?.items || []),
    [dataTonghopquatgio]
  );
