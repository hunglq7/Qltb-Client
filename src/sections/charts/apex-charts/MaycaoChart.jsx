...
const MaycaoChart = () => {
  const { dataTonghopMaycao, loading, fetchTonghopMaycao } = useTonghopmaycaoStore();
  useEffect(() => {
    fetchTonghopMaycao();
  }, []);
  ...
  const listData = useMemo(
    () => (Array.isArray(dataTonghopMaycao) ? dataTonghopMaycao : dataTonghopMaycao?.items || []),
    [dataTonghopMaycao]
  );
